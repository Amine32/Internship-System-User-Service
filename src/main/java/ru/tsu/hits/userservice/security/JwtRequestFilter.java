...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private static final List<String> EXCLUDED_PATHS = Arrays.asList("/authenticate", "/users/sign-up", "/swagger-ui", "/v3/api-docs", "/swagger-ui.html", "/webjars", "/v2", "/swagger-resources");
